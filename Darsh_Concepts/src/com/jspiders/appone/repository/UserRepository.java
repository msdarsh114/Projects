...
{
	String selectUserQuery ="select *from darsh.Users where email= ?";
	String selectAllUsersQuery ="select *from darsh.Users";
	...
	String userDeleteQuery = "delete from darsh.Users where email=?";
